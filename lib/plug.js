...
exports.resolve = function (query, path, endres, ask) {
  ...
  fs.file (path[1], function (err, file) {
    ...
    findPlug(file, path, data, lookup, end);
  });
};
...
function findPlug(file, path, data, lookup, end) {
  var plug = lookup('plug');
  ...
  if (file.isOfType('dir')) {
    ...
    file.files (function (err, files) {
      ...
      if (plug == null) {
        lookup('plugs.dir', function(plug) {
    ...
    file.ot(camp.io, function(err) {
      if (plug == null) {
        lookup('plugs.text', function(plug) {
    ...
    if (plug == null) {
      lookup('plugs.binary', function(plug) {
