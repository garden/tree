...
exports.create = create;    // ✓ PUT /, MKCOL /
exports.read = read;        // ✓ GET /?app=data Depth:3, ?app=metadata
exports.meta = metaSave;    // ✓ PUT /?app=metadata Content-Type:application/json
exports.upload = upload;    // ✓ PUT /, POST /?op=append&content Content-Type:multipart/form-data
// POST /?op=append (content is appended)
exports.apply = apply;      // PATCH /, ?app=metadata
// ✓ websocket /?op=edit&app=text (let's support text, json, maybe binary)
exports.rm = rm;            // ✓ DELETE /
// COPY /from Destination:/to Overwrite:T
// MOVE /from Destination:/to Overwrite:F
exports.shell = shell;      // POST /?op=shell&cmd=make&keep=a.out (stdin is content, stdout is result, unless websocket.)
